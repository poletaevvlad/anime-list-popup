...
const StateChangeModal = (props: StateChangeModalProps) => {
    const currentStatusLabel = statusLabels.find(e => e.key == props.currentStatus).label
    const suggestedStatusLabel = statusLabels.find(e => e.key == props.suggestedStatus).label

    return <div className="modal-background">
        <div className="modal">
            <div className="modal-title">Would you like to change the status of this anime?</div>
            ...
            <div className="state-change-buttons">
                ...
                <button className="button" onClick={props.onAccepted} autoFocus={true}>
